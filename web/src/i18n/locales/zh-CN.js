export default {
  ...
  notification: {
    title: '通知管理',
    subtitle: '统一管理 Webhook 通道和设备事件提醒',
    webhook: 'Webhook 通道',
    webhookDesc: '保留原短信转发配置，并用于其他设备事件。',
    enableDesc: '开启后，已启用的事件规则会发送通知。',
    eventsTitle: '通知列表',
    eventsDesc: '只有列表中的通知项会触发；轮询事件每 30 秒检查一次。',
    addRule: '添加通知',
    addFirstRule: '添加第一条通知',
    editRule: '编辑通知',
    deleteRule: '删除通知',
    confirmDeleteRule: '确定删除“{event}”通知吗？',
    ruleAdded: '通知项已添加',
    ruleUpdated: '通知项已更新',
    ruleDeleted: '通知项已删除',
    deleteFailed: '删除失败',
    emptyRules: '通知列表为空，当前不会触发任何通知。',
    allEventsAdded: '所有可用事件都已加入通知列表',
    selectEvent: '选择事件',
    threshold: '阈值',
    unit: '单位',
    active: '已启用',
    ...
    loadFailed: '通知配置加载失败',
    logsFailed: '通知日志加载失败',
    templateHelp: '支持 #{event}、#{title}、#{message}、#{sender}、#{content}、#{time}',
    logsTitle: '通知发送日志',
    noLogs: '暂无通知日志',
    sent: '发送成功',
    failed: '发送失败',
    events: {
      smsReceived: '收到新短信',
      smsReceivedDesc: 'oFono 收到新短信时提醒。',
      login: '登录提醒',
      loginDesc: '管理界面登录成功时提醒。',
      rj45Changed: 'RJ45 接入变化',
      rj45ChangedDesc: '检测到可用 RJ45 接口接入或断开时提醒。',
      networkInterfaceChanged: '网络接口变化',
      networkInterfaceChangedDesc: '网络接口出现、消失或状态变化时提醒。',
      ipChanged: 'IP 地址变化',
      ipChangedDesc: 'IPv4 或 IPv6 地址变化时提醒。',
      deviceChanged: '接入设备变化',
      deviceChangedDesc: 'WiFi、USB 或 RJ45 接入设备变化时提醒。',
      operatorChanged: '运营商切换',
      operatorChangedDesc: '内置卡通过 goform 切换运营商后提醒。',
      signalLow: '信号低于阈值',
      signalLowDesc: '信号百分比或 dBm 低于设定值时提醒。',
      trafficThreshold: '流量超过阈值',
      trafficThresholdDesc: '累计流量或已配置限制的使用百分比超过设定值时提醒。',
      networkTypeChanged: '4G/5G 切换',
      networkTypeChangedDesc: '网络类型从 4G 与 5G 之间变化时提醒。',
      deviceStatus: '设备网络状态',
      deviceStatusDesc: '数据网络接口连接或断开时提醒。'
    }
  },
  ...
  settings: {
    ...
    darkMode: '深夜模式',
    lightMode: '白天模式',
    telemetryTitle: '日志与遥测上传',
    telemetryDesc: '上传设备运行状态、流量和非敏感日志到自定义接收端。',
    telemetryUrl: '接收 URL',
    telemetryToken: '分组 Token',
    telemetryTokenConfigured: 'Token 已配置，留空保持不变',
    telemetryTokenPlaceholder: '输入分组 Token',
    telemetryClearToken: '清除已保存 Token',
    telemetryInterval: '完整快照周期（秒）',
    telemetryHttpWarning: 'HTTP 不加密，分组 Token 可能被截获。',
    telemetrySave: '保存配置',
    telemetryTest: '测试连接',
    telemetryRunning: '运行状态',
    telemetryLastSuccess: '最近成功',
    telemetrySentCount: '成功分片',
    telemetryFailedCount: '失败分片',
    telemetryNever: '暂无',
    telemetryLoadFailed: '读取遥测配置失败',
    telemetryIntervalInvalid: '周期必须为 10 到 3600 秒',
    telemetryUrlRequired: '启用上传前请输入接收 URL',
    telemetrySaved: '遥测配置已保存',
    telemetrySaveFailed: '保存遥测配置失败',
    telemetryTestSuccess: '遥测接收端连接成功',
    telemetryTestFailed: '遥测接收端连接失败'
  },
